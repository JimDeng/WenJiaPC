...
namespace yoogacatering.Printer
{
    class BarBillDetailPrinter
    {
        ...
        public BarBillDetailPrinter(BillDetailInfo dinfo, string tabName, string type)
        {
            this.dinfo = dinfo;
            this.tabName = tabName;
            this.type = type;

            PrintUtils.SetDefaultPrint(PrintUtils.GetBarPrintName());
        ...
        void pdDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString(dinfo.Time, new Font("Arial", 10), Brushes.Black, 80, y + 80);
